...
## Version 10.2.0+1 (2026-05-18)

Posix compliance, copyright, and Codeberg

Note: Version semantics modified to use proper versioning. This project will
follow Splunk's version (maj.min.patch) with "+bumpnum" to indicate that
there have been changes from their version that have been released with the
initial version being maj.min.patch+0.

Changes:

- Update URLs to point to codeberg.org/merdely/TA-unix
- Update copyright for 2026
- Add links to Github for Issues/Pull Requests
- Make run_nix_ta_commands posix compliant
